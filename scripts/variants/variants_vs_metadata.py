...
for i in range(2):
    fig = plt.figure(constrained_layout=True, figsize=(18,24)) #, axs = plt.subplots(nrows=3, ncols=2, figsize=(20,24))
    ...
    plt.savefig(f"data/processed/variants/variants_vs_metadata_{i}.pdf")
    plt.savefig(f"data/processed/variants/variants_vs_metadata_{i}.png")
    plt.show()