...
plt.savefig("data/processed/variants/variant_bigraph_unfiltered.pdf")
plt.show()
...
plt.savefig("data/processed/variants/variant_kamada_kawai_graph_unfiltered.pdf")
plt.show()
...
plt.savefig("data/processed/variants/sample_similarity_unfiltered.pdf")
plt.show()
...
plt.savefig("data/processed/variants/sample_linkage_unfiltered.pdf")
plt.show()
...
plt.savefig("data/processed/variants/variant_similarity_unfiltered.pdf")
plt.show()
...
plt.savefig("data/processed/variants/variant_linkage_unfiltered.pdf")
plt.show()
...
with Plotter(filename="data/processed/variants_by_position.pdf", figsize=(12,12)) as ax:
    counts.T.plot(ax=ax)
